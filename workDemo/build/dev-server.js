...
var navList = require('../mock/navData.json')
...
var fenleiData = require('../mock/fenleiData.json')
var pinpaiData = require('../mock/pinpaiData.json')
var shopData = require('../mock/shopData.json')
// 引入数据库
...
apiRoutes.get('/fenleiData', function (req, res) {
  res.json(fenleiData);
})
apiRoutes.get('/pinpaiData', function (req, res) {
  res.json(pinpaiData);
})
apiRoutes.get('/shopData', function (req, res) {
  res.json(shopData);
})
// 调用api
